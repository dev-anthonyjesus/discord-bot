...
# ── Emojis ──────────────────────────────────────────────────────────────────
# Aqui ficam apenas os IDs.
# Os PartialEmoji devem ser criados nos arquivos que usam nextcord.
...
DB_FILE = "json/database.json"
ARQUIVO_ECONOMIA = DB_FILE

CASAMENTO_FILE = "json/casamento_compatibilidade.json"
BEBE_FILE = "json/bebe_virtual.json"
PANEL_FILE = "json/panel_messages.json"
TICKET_CONFIG_FILE = "json/ticket_config.json"
TICKET_STATE_FILE = "json/ticket_state.json"
...
BEBE_IMAGENS = {
    ...
    "dormindo": os.path.join(PASTA_IMAGENS_BEBE, "dormindo.png"),
}
